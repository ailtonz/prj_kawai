    ...
    <div id="divCalendario" runat="server" visible="true">
        <div class="fleft m10r">
            <asp:Calendar ID="CalendarioReservas" runat="server" BackColor="White" BorderColor="#3366CC"
                ...
                OnDayRender="CalendarioReservas_DayRender">
        ...
        <div class="fleft m10l">
            <div id="divFuncoes" runat="server" visible="true">
                ...
                <asp:Button ID="btnFiltro" runat="server" CssClass="padButton" Text="FILTRAR RESERVAS"
...
<%--                <asp:Button ID="btnFiltroCliente" runat="server" CssClass="padButton" Text="FILTRO"
    ...
    <div id="divReserva" runat="server" visible="false">
        ...
        <div class="fleft m10r">
            Codigo:
            <br />
            <asp:TextBox ID="txtCodigo" runat="server" Enabled="False" Width="80px"></asp:TextBox>
        </div>
        <div class="fleft m10r">
            Data Cadastro:
            <br />
            <asp:TextBox ID="txtDataCadastro" runat="server" Enabled="False" Width="120px" MaxLength="255"></asp:TextBox>
        </div>
        <div class="fleft m10r">
            Status:
            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddlStatus"
                ...
                ValidationGroup="formReserva"></asp:CompareValidator>
            <br />
        ...
        <div class="fleft m10r">
            Data da Reserva:
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDataReserva"
                ErrorMessage="*" ForeColor="Red" SetFocusOnError="True" ValidationGroup="formReserva">*</asp:RequiredFieldValidator>
            <br />
        ...
        <div class="fleft m10r">
            Estudio:
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlEstudio"
                Operator="NotEqual" ValueToCompare="Selecione" ErrorMessage="*" ForeColor="Red"
                SetFocusOnError="True" ValidationGroup="formReserva"></asp:CompareValidator>
            <br />
        ...
        <div class="fleft m10r">
            Cliente:
            <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="ddlCliente"
                Operator="NotEqual" ValueToCompare="Selecione" ErrorMessage="*" ForeColor="Red"
                SetFocusOnError="True" ValidationGroup="formReserva"></asp:CompareValidator>
            <br />
        ...
        <div class="fleft m10r">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRequisitante"
                ErrorMessage="*" ForeColor="Red" SetFocusOnError="True" ValidationGroup="formReserva">*</asp:RequiredFieldValidator>
            <br />
        ...
        <div class="fleft m10r">
            Responsavel Kawai:
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtResponsavel"
                ErrorMessage="*" ForeColor="Red" SetFocusOnError="True" ValidationGroup="formReserva">* CAMPOS OBRIGATORIOS</asp:RequiredFieldValidator>
            <br />
