...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="fleft m10r">
        ...
        <asp:Button ID="btnFiltro" runat="server" CssClass="padButton" Text="Filtro" 
        ...
        <div class="fleft m10l">
            <div id="divFiltro" runat="server" visible="false">
                ...
                <div class="fleft m10r">
                    Despesa:
                    <br />
                    <asp:DropDownList ID="ddlFiltrarConta" runat="server" Width="750px">
                    </asp:DropDownList>
                </div>
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table1 w100pct tcenter m10t ui-corner-all"
        ...
        <Columns>
            <asp:BoundField DataField="codigo" HeaderStyle-CssClass="tleft" HeaderText="Código"
                ...
                <ItemStyle CssClass="tleft" Width="50px" Wrap="False"/>
            </asp:BoundField>
            ...
            <asp:BoundField DataField="dataPagamento" HeaderText="Pagamento" SortExpression="dataPagamento"
