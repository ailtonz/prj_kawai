<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CadastroPlanoContas.aspx.cs" Inherits="kawaiWeb.CadastroPerfil" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        Serviço:
        <br />
        <asp:TextBox ID="txtServico" runat="server" Width="400px" MaxLength="255"></asp:TextBox>
    </p>
    <p>
        Valor:
        <br />
        <asp:TextBox ID="txtValor" runat="server" Width="500px" MaxLength="500"></asp:TextBox>
    </p>
    <p>
    ...
    <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" CssClass="table1 w100pct tcenter m10t ui-corner-all"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="perfil" HeaderText="Perfil" ItemStyle-CssClass="w1pct nowrap"
